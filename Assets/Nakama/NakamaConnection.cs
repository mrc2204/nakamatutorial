...
public class NakamaConnection : ScriptableObject
{
    ...
    public string Host = "45.32.106.233";
    ...
    public async Task Connect()
    {
        ...
        if (Session == null)
        {
            ...
            deviceId = "141asffgas223" + (int)(UnityEngine.Random.Range(100, 1000000)); ;
    ...
    public async Task FindMatch(int minPlayers = 2)
    {
        ...
        //var matchmakerTicket = await Socket.JoinMatchAsync("b6c4c321-378a-4a18-9cd6-1e1352e3a931.nakama");
    ...
    {
        await Socket.LeaveMatchAsync(currentMatchmakingTicket);
    }
}
