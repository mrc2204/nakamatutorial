...
public class PlayerInputController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        InputChanged = (horizontalInput != HorizontalInput || VerticalInput  != verticalInput || jump != Jump || jumpHeld != JumpHeld || attack != Attack);
        ...
        playerMovementController.SetVeticalMovement(VerticalInput);
