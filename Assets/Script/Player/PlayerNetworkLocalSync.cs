    ...
    private void LateUpdate()
    {
        ...
        if (stateSyncTimer <= 0)
        {
            ...
            gameManager.SendMatchState(
                ...
                MatchDataJson.VelocityAndPosition(playerRigidbody.velocity, playerTransform.position + Vector3.forward  ));
        ...
        gameManager.SendMatchState(
            OpCodes.Input,
            MatchDataJson.Input(playerInputController.HorizontalInput,playerInputController.VerticalInput, playerInputController.Jump, playerInputController.JumpHeld, playerInputController.Attack)
        );
    }
}
